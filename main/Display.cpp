...
void Display::mostraTensaoEVel(float velocidade, Motor &motor){
...
void Display::atualizaDisplay( float velocidade, int FSMState, Motor &motor) {

  String FSMState_str;
if ( (millis() - timeOld) >= timeInterval){

  mostraTensaoEVel(velocidade, motor);
