...
StartStop::StatesManipulaBorboleta borboleta = StartStop::manterAcelera;
...
StartStop::StatesStartStop StartStop::manipulaBorboleta (Motor &motor, float &tempoUltimoImcremento) {
