...
class Velocidade {
public:
    static float velocidade_rpm;
    static float acelera_2;
    ...
    static float calculaVelocidade2(int tempUltimoCal);

    //Funções para calculo da aceleração instantânea
    static float calculaAcelera();
    /**
...
private:
    ...
    static float acelera;
    static unsigned long pulsos;
    static unsigned long timeAcelera;
};
#endif
