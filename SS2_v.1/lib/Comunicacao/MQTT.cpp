...
MQTT* MQTT::instancia = nullptr;

void MQTT::conectar_mqtt() {
    instancia = this; 
...
void MQTT::callbackRouter(char* topic, byte* payload, unsigned int length) {
...
void MQTT::publicar_telemetria(float* dados, const char** Nome_dados, size_t quantidade_dados, const char* topico) {
