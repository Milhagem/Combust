...
class Display {
    ...
    */
    void mostraTensaoEVel(float velocidade, float aceleracao);
    /**
    ...
    */
    void atualizaDisplay ( float velocidade, int FSMState, float &acelera, Motor &motor);
