...
class Display {
    ...
    */
     ...
     * @param velocidade Velocidade a ser exibida
    */
    void mostraTensaoEVel(Motor &motor, int velocidade, int generic_number2);
    /**
    ...
    */
    void atualizaDisplay(Motor &motor, int velocidade, int FSMState_int, int generic_number);
